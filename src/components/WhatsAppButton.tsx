...
export default function WhatsAppButton() {
  const message = encodeURIComponent(
    "Olá! Vim pelo site da Heracorp e gostaria de saber mais sobre os serviços."
  );
  ...
  return (
    <a
      ...
      aria-label={`Fale conosco pelo WhatsApp: ${COMPANY.whatsappFormatted}`}
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-[#25D366] text-white rounded-full shadow-lg hover:bg-[#20b858] transition-all hover:scale-105 group"
    >
